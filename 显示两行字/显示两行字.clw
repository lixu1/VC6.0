...
NewFileInclude2=#include "显示两行字.h"
LastPage=0
...
Type=0
HeaderFile=显示两行字.h
ImplementationFile=显示两行字.cpp
Filter=N

[CLS:CMyDoc]
Type=0
HeaderFile=显示两行字Doc.h
ImplementationFile=显示两行字Doc.cpp
Filter=N

[CLS:CMyView]
Type=0
HeaderFile=显示两行字View.h
ImplementationFile=显示两行字View.cpp
Filter=C
